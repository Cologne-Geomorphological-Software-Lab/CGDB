...
class _BibliographySetup(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.second_author = Author.objects.create(
            last_name="Schmidt", first_name="Eva"
        )
...
class ReferenceOrderingTest(_BibliographySetup):
    ...
    def test_ordering_secondary_by_title(self):
        ...
        same_year = Reference.objects.filter(year=2018).order_by(
            "year", "title"
        )
